class Virglrenderer < Formula
  ...
  depends_on "heegoo-han/qemu-virgl/libangle"
  depends_on "heegoo-han/qemu-virgl/libepoxy-angle"
  ...
  def install
    mkdir "build" do
      system "meson", *std_meson_args, "-Dc_args=-I#{Formula["heegoo-han/qemu-virgl/libepoxy-angle"].opt_prefix}/include",
             "-Dc_link_args=-L#{Formula["heegoo-han/qemu-virgl/libepoxy-angle"].opt_prefix}/lib", ".."
      system "ninja", "-v"
